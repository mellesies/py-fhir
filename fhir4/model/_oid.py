...
class oid(BaseType):
    """Autogenerated oid type."""
    
    value = Property('value', str, '1', '1', 'xmlAttr')
    
    def __init__(self, value=None):
        """Initialize a new oid instance."""
        if value is not None:
            value = str(value)

        super(oid, self).__init__(value)
    ...
    def __add__(self, other):
        if isinstance(other, oid):
            return oid(self.value.__add__(other.value))
        elif isinstance(other, str):
    ...
    def __mul__(self, other):
        """x * y <==> x.__mul__(y)"""
        return oid(str(self).__mul__(other))
