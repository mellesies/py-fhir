...
class markdown(BaseType):
    """Autogenerated markdown type."""
    
    value = Property('value', str, '1', '1', 'xmlAttr')
    
    def __init__(self, value=None):
        """Initialize a new markdown instance."""
        if value is not None:
            value = str(value)

        super(markdown, self).__init__(value)
    ...
    def __add__(self, other):
        if isinstance(other, markdown):
            return markdown(self.value.__add__(other.value))
        elif isinstance(other, str):
    ...
    def __mul__(self, other):
        """x * y <==> x.__mul__(y)"""
        return markdown(str(self).__mul__(other))
